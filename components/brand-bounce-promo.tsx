...
import { ArrowRight, Palette, Video, Layers, MessageSquare, FileImage } from "lucide-react"
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <p className="text-lg text-gray-600">
            While TaskBounce handles your productivity needs, our parent company BrandBounce can transform your visual
            identity with professional design services.
          </p>
        </motion.div>
          ...
          {[
            {
              ...
              title: "Logo Design",
              description: "Create a unique, memorable logo that captures the heart of your brand.",
              color: "bg-blue-100",
            },
            {
              icon: <Video className="w-6 h-6 text-orange-500" />,
              title: "Video Editing",
              description: "Bring your story to life with professional video editing.",
              color: "bg-orange-100",
            },
            {
              icon: <Layers className="w-6 h-6 text-blue-500" />,
              title: "Branding",
              description: "Develop a cohesive brand identity, including color schemes and typography.",
              color: "bg-blue-100",
            },
            {
              icon: <MessageSquare className="w-6 h-6 text-blue-500" />,
              title: "Social Media Marketing",
              description: "Grow your online presence with engaging content and targeted strategies.",
              color: "bg-blue-100",
            },
            {
